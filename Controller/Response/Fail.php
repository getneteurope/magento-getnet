    ...
    public function execute()
{
    ...
    try {
              ...
              $this->logger->debug('Try with refID');
              $order->addStatusToHistory('canceled',__('Payment Failed'), false);
              $order->save();
    
              $this->messageManager->addErrorMessage(__("Technical error in the payment"));
