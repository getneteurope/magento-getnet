...
define(
    ...
    function ($, quote, fullScreenLoader,urlBuilder) {
        ...
        return function (payload,messageContainer) {
            ...
            var customLink = urlBuilder.build('paymagento');
            ...
            fullScreenLoader.startLoader();
                ...
                $.get(customLink + "/webhook/callback?email=" + vEmail + "&cartId="+id +"_"+ add+ "&dominio="+customLink, function (result) {
            				if(result=="-") 
                                $.mage.redirect(customLink + "/Response/Fail?email=" + vEmail + "&cartId="+id + "&amount="+amount);
                            else 
